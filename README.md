...
1. Run the following command to fetch the content from Sanity:
        ...
        npx @stackbit/stackbit-pull --stackbit-pull-api-url=https://api.stackbit.com/pull/5fee17f71ff91e0015889029
...
To start editing your site, you can use the Sanity interface at https://maroon-aluminum-e17f7.sanity.studio/.
...
Generated at `2020-12-31T18:33:02.864Z` by Stackbit version `0.3.42`.